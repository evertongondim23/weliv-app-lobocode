...
import type { QuickActionsSectionProps } from '../types/patient-dashboard.types';
        ...
        {actions.map((action, index) => (
          ...
          >
            <div className="flex flex-col lg:flex-row items-center gap-2 lg:gap-3 w-full">
              ...
              <span className="font-medium text-xs lg:text-sm text-center lg:text-left" style={{ color: TEXT_PRIMARY_COLOR }}>
                {action.label}
              </span>
            </div>
            <ArrowRight
